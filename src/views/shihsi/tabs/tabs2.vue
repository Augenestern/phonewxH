...
setTimeout(() => {
    ...
    yaliData.y1Data = [4, 4, 6, 3, 6, 2, 3, 5, 4, 4, 6, 11, 6, 2, 3, 4, 4, 4, 6, 6, 4, 3, 4, 3]
    ...
    qianduanyaliData.y1Data = [6, 6, 3, 6, 2, 3, 5, 4, 4, 16, 4, 3, 4, 4, 4, 3, 6, 2, 3, 4, 4, 4, 6, 3]
    ...
    liuliangData.y1Data = [6, 4, 3, 4, 4, 4, 6, 3, 6, 2, 3, 15, 4, 4, 6, 3, 6, 2, 3, 4, 4, 4, 6, 3]
    ...
    wenduData.y1Data = [6, 6, 2, 3, 5, 4, 4, 6, 3, 4, 3, 4, 14, 4, 6, 3, 6, 2, 3, 4, 4, 4, 6, 3]
}, 1000);
onMounted(() => {
    console.log(1111);
})
